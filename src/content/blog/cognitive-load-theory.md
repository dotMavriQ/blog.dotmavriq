...
There are stretches of time where you feel like you're running on fumes and you can't really explain why. You slept okay. You ate. Nobody yelled at you. But your brain just won't cooperate. You sit down to do something and the gears don't turn.
...
[Cognitive Load Theory](https://en.wikipedia.org/wiki/Cognitive_load) was originally developed by [John Sweller](https://en.wikipedia.org/wiki/John_Sweller) in the late 80s as a framework for instructional design. The basic idea is that your [working memory](https://en.wikipedia.org/wiki/Working_memory) can only hold so much at once. When you overload it, performance drops. Learning stops. Decision-making gets worse.
...
Folders, labels, filters. Whatever your email client supports, use it. The goal is that when you open your inbox, you see what matters and the rest is already sorted. [Inbox Zero](https://en.wikipedia.org/wiki/Merlin_Mann#Inbox_Zero) isn't about being obsessive. It's about not starting your day with a wall of noise.

### Your shortcuts

Learn the keyboard shortcuts for the tools you use every day. Set up [aliases](https://en.wikipedia.org/wiki/Alias_(command)) in your terminal. Create text expansion snippets for things you type often. Every time you reach for the mouse to do something you could have done with a keystroke, that's a micro-drain. One doesn't matter. Fifty a day does.

### Your phone

Turn off notifications for things that aren't urgent. Every buzz is an interruption and every interruption is a [context switch](https://en.wikipedia.org/wiki/Human_multitasking). Every context switch costs recovery time. Your phone should be a tool, not a slot machine.
...
A calendar reminder doesn't forget. A [cron job](https://en.wikipedia.org/wiki/Cron) doesn't get tired. A well-organized note system doesn't lose track of things after a long week. Let the machines handle the stuff that machines are good at so your brain can focus on the stuff that only a brain can do.

Write things down. Set reminders. Automate what you can. Not because you're broken, but because [working memory](https://en.wikipedia.org/wiki/Working_memory) is genuinely limited to about four things at a time and pretending otherwise is how you end up staring at a screen at 15:00 wondering what you were supposed to be doing.
