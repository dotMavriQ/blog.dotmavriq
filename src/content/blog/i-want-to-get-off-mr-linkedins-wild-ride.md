---
title: "I Want to Get Off Mr. LinkedIn's Wild Ride"
pubDate: 2026-04-19
excerpt: "LinkedIn is still where software work happens, which is the part that hurts. A short essay on the panopticon logic of professional networking, why nobody has replaced it, and the people who have at least tried."
tags: [Digital Freedom]
heroImage: "/img/blog/mr-linkedins-wild-ride.webp"
draft: false
---
...
That dialect has a name in linguistics. [Jürgen Habermas](https://en.wikipedia.org/wiki/J%C3%BCrgen_Habermas) drew a clean distinction between **communicative action**, where two people speak to reach actual understanding, and **strategic action**, where speech is a tool aimed at producing an effect in the listener.[^habermas] LinkedIn is structurally incapable of the first and almost entirely built on the second. A genuine loss has to be framed as "the leadership lesson I learned this quarter." A promotion has to be "humbled" because the alternative reads as arrogant. The interface is not the problem. The incentives are.

[Byung-Chul Han](https://en.wikipedia.org/wiki/Byung-Chul_Han) gave the related, sharper version: we now live inside what he calls a *transparency society* and an *achievement society*, where private interiority is smoothed flat into marketable surface and the worker is an entrepreneur of their own self, performing productivity not because anyone is forcing them to but because they no longer notice the difference between work and identity.[^han] The platform does not need to surveil you. You surveil yourself, in the third person, in real time, on a public timeline, and you call it personal branding.
...
The dialect is so well-codified at this point that the paid search engine Kagi ships a ["LinkedIn-speak translator"](https://translate.kagi.com/?from=en&to=LinkedIn+speak) as one of its built-in assistant tools, the entire job of which is to convert phrases like "humbled and excited to announce" back into "I got a job." Take a moment with that. A search engine built an opinionated piece of software whose explicit purpose is to undo the way a generation of professionals has been taught to communicate. That tool exists because the demand for it is real.
...
I have written at some length about [what AI has actually done to my work](/blog/ai-a-retrospective). Hiring is where its weirdness lands hardest, because both sides of the table are now using the same tools against each other.
...
[^habermas]: Habermas, J. (1981). *Theorie des kommunikativen Handelns*. Suhrkamp. English: *The Theory of Communicative Action* (1984, 1987, Beacon Press, trans. T. McCarthy). The distinction between communicative and strategic action is developed across both volumes.

[^han]: Han, B.-C. (2012). *Transparenzgesellschaft*. Matthes & Seitz. English: *The Transparency Society* (Stanford University Press, 2015). See also Han, B.-C. (2010). *Müdigkeitsgesellschaft*. English: *The Burnout Society* (Stanford University Press, 2015). The argument about auto-exploitation under the "achievement society" runs through both.

[^microsoft]: Microsoft. (2016). [Microsoft to acquire LinkedIn](https://news.microsoft.com/2016/06/13/microsoft-to-acquire-linkedin/). Announced 13 June 2016; the $26.2 billion deal closed in December of the same year.
